...
public class LiveAdapter extends RecyclerView.Adapter<LiveAdapter.ViewHolder> {
    ...
    public LiveAdapter(ArrayList<String> mData, Context context) {
        this.mData = mData;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.stock_live_item_matches, parent, false);
