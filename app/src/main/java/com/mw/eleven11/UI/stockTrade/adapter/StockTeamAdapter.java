...
public class StockTeamAdapter extends RecyclerView.Adapter<StockTeamAdapter.ViewHolder> {
    ...
    public StockTeamAdapter(ArrayList<String> mData, Context context) {
        this.mData = mData;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.stock_team_item_matches, parent, false);
