...
public class CustomPinView extends AppCompatEditText {
    ...
    public CustomPinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.CustomPinView, defStyleAttr, 0);

        mPinItemCount = a.getInt(R.styleable.CustomPinView_boxCount, DEFAULT_COUNT);
        mPinItemSize = a.getDimensionPixelSize(R.styleable.CustomPinView_boxHeight,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelOffset(R.styleable.CustomPinView_boxMargin,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = a.getDimensionPixelOffset(R.styleable.CustomPinView_boxRadius,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_radius));

        if (a.hasValue(R.styleable.CustomPinView_itemCount)) {
            mPinItemCount = a.getInt(R.styleable.CustomPinView_itemCount, DEFAULT_COUNT);
        }
        if (a.hasValue(R.styleable.CustomPinView_itemSize)) {
            mPinItemSize = a.getDimensionPixelSize(R.styleable.CustomPinView_itemSize,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        }
        if (a.hasValue(R.styleable.CustomPinView_itemSpacing)) {
            mPinItemSpacing = a.getDimensionPixelOffset(R.styleable.CustomPinView_itemSpacing,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_spacing));
        }
        if (a.hasValue(R.styleable.CustomPinView_itemRadius)) {
            mPinItemRadius = a.getDimensionPixelOffset(R.styleable.CustomPinView_itemRadius,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_radius));
        }

        mBorderWidth = a.getDimensionPixelOffset(R.styleable.CustomPinView_borderWidth,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_border_width));
        mBorderColor = a.getColorStateList(R.styleable.CustomPinView_borderColor);
